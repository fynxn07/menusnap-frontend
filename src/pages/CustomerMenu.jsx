...
const CustomerMenu = () => {
  ...
  useEffect(() => {
    if (location.state?.addToCart) {
      ...
      toast.success(`${location.state.addToCart.name} added to cart!`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <header className="bg-white sticky top-0 z-50 shadow-sm">
        ...
        {categories.length > 0 && (
          <div 
            className="flex overflow-x-auto border-b category-tabs"
            style={{
              msOverflowStyle: 'none',
              scrollbarWidth: 'none',
            }}
              ...
              <div className="space-y-4">
                {groupedMenu[category].map((item) => (
                  <div
                    ...
                    className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden cursor-pointer active:scale-[0.98]"
                  >
                    <div className="flex items-center p-4 gap-4">
                      {/* Item Details */}
                      <div className="flex-1 min-w-0">
      ...
      {cartCount > 0 && (
        <div className="fixed bottom-0 left-0 right-0 p-4 pointer-events-none" style={{
          ...
          <button
            onClick={goToCart}
            className="w-full max-w-md mx-auto bg-emerald-500 text-white rounded-2xl py-4 px-6 flex items-center justify-between shadow-lg hover:bg-emerald-600 transition-all pointer-events-auto active:scale-95"
          >
            <div className="flex items-center gap-3">
              <div className="relative">
                <ShoppingCart className="w-6 h-6" />
