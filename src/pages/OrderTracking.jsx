...
//       // ⭐ AUTO-REDIRECT when order is served
//       if (data.status === "SERVED") {
//         setTimeout(() => {
//           navigate(`/menu/${data.restaurant_id}/${data.table_id}`, { replace: true });
//         }, 3000); // Wait 3 seconds to show "Served" status, then redirect
//       }
//     } catch (err) {
//       console.error(err);
//       setLoading(false);
...
//   // ⭐ Handle back button - go to menu (clears cart automatically)
//   const handleBackNavigation = () => {
//     if (order) {
//       navigate(`/menu/${order.restaurant_id}/${order.table_id}`, { replace: true });
//     } else {
//       navigate(-1);
//     }
//   };
...
//         {/* Show message when order is served */}
//         {order.status === "SERVED" && (
